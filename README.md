...
| appearance               | `'fill' \| 'outline'`      | `fill`                                                                                                                                                                                                                                                                                                       | Material form field appearance. With `'outline'`, the main label renders inside the country selector's notched outline (matching Material Design); with `'fill'`, it renders above the form field. |
